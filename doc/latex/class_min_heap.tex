...
\item 
\mbox{\hyperlink{class_min_heap_a23409394bd070f4176c76e3e4771fa6b}{Min\+Heap}} (\mbox{\hyperlink{class_entry}{Entry}}$<$ K, V $>$ $\ast$array\+To\+Build\+From, long int size\+Of\+Array\+To\+Build\+From)
\begin{DoxyCompactList}\small\item\em Constructor, initializes the {\itshape array}. \end{DoxyCompactList}\item 
\mbox{\hyperlink{class_min_heap_a7d3b7adb9d4641f584759332b03c3002}{Min\+Heap}} (long int \mbox{\hyperlink{class_min_heap_ab786b8a2bc4f26771da208663efcdbe7}{physical\+Size}})
...
void \mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap}} (long int index\+To\+Fix\+From) override
...
void \mbox{\hyperlink{class_min_heap_ac20e4bccc3dda5967b2db159cefe1481}{build\+Heap}} (\mbox{\hyperlink{class_entry}{Entry}}$<$ K, V $>$ $\ast$array\+To\+Build\+From, long int size\+Of\+Array\+To\+Build\+From) override
...
void \mbox{\hyperlink{class_min_heap_a6f9f4fe628cfb022d4ef01e8ae3da43c}{fix\+Heap\+Legal\+Index}} (long int index\+To\+Fix\+From)
\begin{DoxyCompactList}\small\item\em This method is a {\itshape private} method, that represents the case when the provided {\ttfamily current\+Index} is a legal index. This method is being invoked by the \mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap(long int)}} method. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{class_min_heap_a331e48e76ce1e2bb93bda0f05bca2c94}{fix\+Heap\+While}} (long int current\+Index)
\begin{DoxyCompactList}\small\item\em This method is a {\itshape private} method, that represents a {\ttfamily while} that is being invoked by the \mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap(long int)}} method. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item 
long int \mbox{\hyperlink{class_min_heap_ab786b8a2bc4f26771da208663efcdbe7}{physical\+Size}} = 0
...
long int \mbox{\hyperlink{class_min_heap_a23b483bad2c38288a8e0aa82c5e1d22b}{logical\+Size}} = 0
...
\begin{DoxyItemize}
\item Once the heap has been built by \mbox{\hyperlink{class_min_heap_ac20e4bccc3dda5967b2db159cefe1481}{build\+Heap}} or \mbox{\hyperlink{class_min_heap_a23409394bd070f4176c76e3e4771fa6b}{Min\+Heap(\+Entry$<$\+K, V$>$ $\ast$, long int)}}, its {\itshape physical-\/size} is treated as a constant -\/ thus unchangeable. In case the user wishes to change the {\itshape physical-\/size} of the heap, there is a {\itshape must} to invoke \mbox{\hyperlink{class_min_heap_ac20e4bccc3dda5967b2db159cefe1481}{build\+Heap}} again. \item The heap compares its elements to each other, by the comparable {\ttfamily key} field located in each {\ttfamily \mbox{\hyperlink{class_entry}{Entry}}} element. 
...
\mbox{\Hypertarget{class_min_heap_a23409394bd070f4176c76e3e4771fa6b}\label{class_min_heap_a23409394bd070f4176c76e3e4771fa6b}} 
...
\mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::\mbox{\hyperlink{class_min_heap}{Min\+Heap}} (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_entry}{Entry}}$<$ K, V $>$ $\ast$}]{array\+To\+Build\+From,  }\item[{long int}]{size\+Of\+Array\+To\+Build\+From }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [explicit]}}



Constructor, initializes the {\itshape array}. 

Builds a {\bfseries{Minimum-\/\+Heap}} by giving an {\ttfamily array\+To\+Build\+From} of {\bfseries{lvalue {\ttfamily Entries}}} as a parameter. Done by invoking the \mbox{\hyperlink{class_min_heap_ac20e4bccc3dda5967b2db159cefe1481}{build\+Heap}} method. 
...
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{class_min_heap_ac20e4bccc3dda5967b2db159cefe1481}{build\+Heap}} 
\end{DoxySeeAlso}
\mbox{\Hypertarget{class_min_heap_a7d3b7adb9d4641f584759332b03c3002}\label{class_min_heap_a7d3b7adb9d4641f584759332b03c3002}} 
\index{MinHeap$<$ K, V $>$@{MinHeap$<$ K, V $>$}!MinHeap@{MinHeap}}
\index{MinHeap@{MinHeap}!MinHeap$<$ K, V $>$@{MinHeap$<$ K, V $>$}}
\doxysubsubsection{\texorpdfstring{MinHeap()}{MinHeap()}\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
{\footnotesize\ttfamily template$<$typename K , typename V $>$ \\
\mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::\mbox{\hyperlink{class_min_heap}{Min\+Heap}} (\begin{DoxyParamCaption}\item[{long int}]{physical\+Size }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [explicit]}}
...
\mbox{\Hypertarget{class_min_heap_ac20e4bccc3dda5967b2db159cefe1481}\label{class_min_heap_ac20e4bccc3dda5967b2db159cefe1481}} 
...
{\footnotesize\ttfamily template$<$typename K , typename V $>$ \\
void \mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::build\+Heap (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_entry}{Entry}}$<$ K, V $>$ $\ast$}]{array\+To\+Build\+From,  }\item[{long int}]{size\+Of\+Array\+To\+Build\+From }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [override]}, {\ttfamily [virtual]}}
...
Implements \mbox{\hyperlink{class_min_heap_a_d_t_adedb61dad12fb1d1cccf9ffd2f92294b}{Min\+Heap\+ADT$<$ K, V $>$}}.
...
\end{DoxyExceptions}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap(long int)}} 
\end{DoxySeeAlso}
...
\mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap(long int)}} 
\end{DoxySeeAlso}
\mbox{\Hypertarget{class_min_heap_a7b33de0ea94032de14ee36637403ac94}\label{class_min_heap_a7b33de0ea94032de14ee36637403ac94}} 
...
{\footnotesize\ttfamily template$<$typename K , typename V $>$ \\
void \mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::fix\+Heap (\begin{DoxyParamCaption}\item[{long int}]{index\+To\+Fix\+From }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [override]}, {\ttfamily [virtual]}}
...
Implements \mbox{\hyperlink{class_min_heap_a_d_t_adb701c12e92102506a5ac1b4d0bfc8ad}{Min\+Heap\+ADT$<$ K, V $>$}}.

\mbox{\Hypertarget{class_min_heap_a6f9f4fe628cfb022d4ef01e8ae3da43c}\label{class_min_heap_a6f9f4fe628cfb022d4ef01e8ae3da43c}} 
...
{\footnotesize\ttfamily template$<$typename K , typename V $>$ \\
void \mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::fix\+Heap\+Legal\+Index (\begin{DoxyParamCaption}\item[{long int}]{index\+To\+Fix\+From }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}



This method is a {\itshape private} method, that represents the case when the provided {\ttfamily current\+Index} is a legal index. This method is being invoked by the \mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap(long int)}} method. 
...
\mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap(long int)}} 
\end{DoxySeeAlso}
\mbox{\Hypertarget{class_min_heap_a331e48e76ce1e2bb93bda0f05bca2c94}\label{class_min_heap_a331e48e76ce1e2bb93bda0f05bca2c94}} 
...
{\footnotesize\ttfamily template$<$typename K , typename V $>$ \\
void \mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::fix\+Heap\+While (\begin{DoxyParamCaption}\item[{long int}]{current\+Index }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}



This method is a {\itshape private} method, that represents a {\ttfamily while} that is being invoked by the \mbox{\hyperlink{class_min_heap_a7b33de0ea94032de14ee36637403ac94}{fix\+Heap(long int)}} method. 
...
Array of pointers to {\bfseries{lvalue {\ttfamily Entries}}} that serve as {\ttfamily elements}. Initialized to {\ttfamily nullptr}. \mbox{\Hypertarget{class_min_heap_a23b483bad2c38288a8e0aa82c5e1d22b}\label{class_min_heap_a23b483bad2c38288a8e0aa82c5e1d22b}} 
...
{\footnotesize\ttfamily template$<$typename K , typename V $>$ \\
long int \mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::logical\+Size = 0\hspace{0.3cm}{\ttfamily [private]}}



The {\itshape logical-\/size} of the {\itshape array}. Initialized to {\ttfamily 0}. 

\mbox{\Hypertarget{class_min_heap_ab786b8a2bc4f26771da208663efcdbe7}\label{class_min_heap_ab786b8a2bc4f26771da208663efcdbe7}} 
...
{\footnotesize\ttfamily template$<$typename K , typename V $>$ \\
long int \mbox{\hyperlink{class_min_heap}{Min\+Heap}}$<$ K, V $>$\+::physical\+Size = 0\hspace{0.3cm}{\ttfamily [private]}}
