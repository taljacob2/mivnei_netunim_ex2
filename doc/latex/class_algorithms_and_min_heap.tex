...
\item (K $\ast$) result\+Array -\/ is the result array. \item (K $\ast$$\ast$) result\+Array -\/ is an array that stores the start {\ttfamily location} of each {\ttfamily small array}. \item (int $\ast$) small\+Array\+Sizes -\/ is an array that stores the {\ttfamily size} of each {\ttfamily small array}. The method creates a {\ttfamily \mbox{\hyperlink{class_min_heap}{Min\+Heap}}}\+: This {\ttfamily \mbox{\hyperlink{class_min_heap}{Min\+Heap}}}\textquotesingle{}s elements are pointers to {\ttfamily Entries} such that each {\ttfamily \mbox{\hyperlink{class_entry}{Entry}}} is composed of a {\ttfamily key} and a {\ttfamily value. Its}key{\ttfamily , stands for the smallest element in each}small array{\ttfamily -\/ and its}value{\ttfamily stands for an $\ast$int$\ast$ number that determines the specific}small array\`{} from which that element came from.\end{DoxyItemize}
\begin{DoxyNote}{Note}
...
the {\ttfamily array} given {\itshape must} be dynamically allocated. 
\end{DoxyAttention}
